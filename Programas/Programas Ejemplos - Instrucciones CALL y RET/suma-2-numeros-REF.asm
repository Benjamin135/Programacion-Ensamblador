...
main:
		nop
;------ paso parametros ---- 
		mov rcx, a	 ;1er. argumento por "referencia"(direccion) -> rcx
		mov rdx, b	 ;2do. argumento por "referencia"(direccion) -> rdx
	
		CALL sumar	 ;llamada subrutina "sumar"
		
		mov [c], rax ;almacenamos resultado
		RET
